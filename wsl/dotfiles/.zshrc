...
# Suppress any initialization output until after prompt
exec 2>/dev/null
...
# Restore stderr after prompt is initialized
exec 2>&1
...
# Note: Disabled due to parse error in generated file
# Regenerate with: p10k configure (requires larger terminal)
# ------------------------------------------------------------------------------
